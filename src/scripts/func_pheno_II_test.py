import json
import sys, os
from modules.param_list_reconstruct import param_list_reconstruct
...
def param_transition(wt_pm_dict, xc_pm_dict, network, logic_label, resultdir=''):
    ...
    param_reconstruct_dict = param_list_reconstruct(wt_pm_dict,xc_pm_dict,noise,network,logic_label)
...
if __name__ == '__main__':
    ...
    param_transition(wt_pm_dict, xc_pm_dict, network, logic_label, noise, resultdir)
