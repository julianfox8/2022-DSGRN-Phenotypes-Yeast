...
#WT queries
#time mpiexec -n 16 python ~/dsgrn_net_query/src/dsgrn_net_query/queries/CountPatternMatch_large_networks_parameter_indices.py ~/dsgrn_net_query/yeast_PM/networks/WT_clb2_nonE_swi5_nrm1.txt ~/dsgrn_net_query/yeast_PM/functional_phenotype_I/wild_type/p_file_wt.json ~/dsgrn_net_query/yeast_PM/functional_phenotype_I/wild_type/swi5_nrm1/  #phenotype I, WT, proxies swi5/nrm1

#time mpiexec -n 16 python ~/dsgrn_net_query/src/dsgrn_net_query/queries/CountPatternMatch_large_networks_parameter_indices.py ~/dsgrn_net_query/yeast_PM/networks/WT_clb2_nonE_swi5_yox1.txt ~/dsgrn_net_query/yeast_PM/functional_phenotype_I/wild_type/p_file_wt.json ~/dsgrn_net_query/yeast_PM/functional_phenotype_I/wild_type/swi5_yox1/  #phenotype I, WT, proxies swi5/yox1

#time mpiexec -n 12 python ~/dsgrn_net_query/src/dsgrn_net_query/queries/CountPatternMatch_large_networks_parameter_indices.py ~/dsgrn_net_query/yeast_PM/networks/WT_clb2_nonE_ace2_nrm1.txt ~/dsgrn_net_query/yeast_PM/functional_phenotype_I/wild_type/p_file_wt.json ~/dsgrn_net_query/yeast_PM/functional_phenotype_I/wild_type/ace2_nrm1/  #phenotype I, WT, proxies ace2/nrm1

#time mpiexec -n 12 python ~/dsgrn_net_query/src/dsgrn_net_query/queries/CountPatternMatch_large_networks_parameter_indices.py ~/dsgrn_net_query/yeast_PM/networks/WT_clb2_nonE_ace2_yox1.txt ~/dsgrn_net_query/yeast_PM/functional_phenotype_I/wild_type/p_file_wt.json ~/dsgrn_net_query/yeast_PM/functional_phenotype_I/wild_type/ace2_yox1/  #phenotype I, WT, proxies ace2/yox1
