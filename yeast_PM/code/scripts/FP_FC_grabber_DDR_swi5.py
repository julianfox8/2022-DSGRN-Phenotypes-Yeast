...
def fp_queries(db):
    ...
    '''
    if os.path.exists("bistable_fp_query_DDR_swi5.json") and os.path.exists("multistable_fp_query_DDR_swi5.json"):
        multistable_fp_filtered =  json.load(open("multistable_fp_query_DDR_swi5.json"))
        bistable_fp_filtered = json.load(open("bistable_fp_query_DDR_swi5.json"))
    else:
        ...
        with open("bistable_fp_query_DDR_swi5.json", "w") as f:
            json.dump(bistable_fp_filtered, f)
        multistable_fp_filtered = query_filter(multistable_fp_dict)
        with open("multistable_fp_query_DDR_swi5.json", "w") as f:
