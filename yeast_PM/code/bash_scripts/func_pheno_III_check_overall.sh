...
#multistable
#swi5_nrm1
python ~/2022-DSGRN-Phenotypes-Yeast/yeast_PM/code/scripts/func_pheno_III_overall.py ~/2022-DSGRN-Phenotypes-Yeast/yeast_PM/networks/WT_with_clb2/WT_clb2_nonE_swi5_nrm1.txt ~/2022-DSGRN-Phenotypes-Yeast/yeast_PM/functional_phenotype_I/wild_type/swi5_nrm1/dsgrn_net_query_results20210913155435/queries20210913155435/query_results_stablefc_orlando2008_WildType_r1_trunc_param_list.json ~/2022-DSGRN-Phenotypes-Yeast/yeast_PM/code/bash_scripts/fp_query_SAC.json ~//2022-DSGRN-Phenotypes-Yeast/yeast_PM/functional_phenotype_I/wild_type/results/
#swi5_yox1
